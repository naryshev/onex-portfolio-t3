			...
			>
				<div className="mx-auto w-full max-w-screen-xl px-4 pb-6 ">
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        ...
                        <span className="text-xs text-zinc-500 sm:text-center dark:text-zinc-400">© 2023 <a href="https://onex.zip/" className="hover:underline">ONEX Records™</a>. All Rights Reserved.</span>
