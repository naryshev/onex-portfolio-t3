...
export const Footer: React.FC = () => {
	...
	return (
		<footer ref={ref}>
			...
			>
				<div className="mx-auto w-full max-w-screen-xl px-6 pb-6 sm:px-2 sm:pb-2">
                    <hr className="mb-6 border-gray-200 mx-auto dark:border-gray-700 sm:mb-2 sm:mx-2" />
                    <div className="flex items-center justify-between">
                        <div className="flex mt-4 space-x-6 justify-center mt-0 pb-2 ">
                            ...
                            <a href="https://twitter.com/1xaniel" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                        ...
                        <span className="text-xs text-zinc-500 text-center dark:text-zinc-400">© 2023 <a href="https://onex.zip/" className="hover:underline">ONEX Records™</a>. <a className="inline-block">All Rights Reserved.</a></span>
