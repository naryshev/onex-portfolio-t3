...
export const Player: React.FC = () => {
	...
	return (
		<div className="flex min-h-screen items-center justify-center  ">
            <div className="w-2/3">
                <div className=" border-zinc-100 dark:bg-zinc-800 dark:border-zinc-500 border-b rounded-t-xl p-4 pb-6 sm:p-10 sm:pb-8 lg:p-6 xl:p-10 xl:pb-8 space-y-6 sm:space-y-8 lg:space-y-6 xl:space-y-8  items-center">
                    <div className="flex items-center space-x-4">
                    <img src="https://is1-ssl.mzstatic.com/image/thumb/Music116/v4/1a/57/56/1a5756bf-1e8b-15ba-6901-4bde09305922/7dae8b2e-f429-4ff1-bba5-d706fa77af27.jpg/316x316bb.webp" alt="" width="270" height="270" class="flex-none rounded-lg bg-slate-100" loading="lazy" />
                    <div className="min-w-0 flex-auto space-y-1 font-semibold">
                        <p className="text-fuchsia-500 dark:text-fuchsia-400 text-sm leading-6">
                            <abbr title="Track">Track:</abbr> 01
                        </p>
                    ...
                    <div className="relative">
                        ...
                        <div className="w-1.5 h-1.5 bg-fuchsia-500 dark:bg-fuchsia-400 rounded-full ring-1 ring-inset ring-zinc-900/5"></div>
                        </div>
                    </div>
