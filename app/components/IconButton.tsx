...
export default function IconButton({
  ...
  const classes = cn(
    'rounded-full flex items-center justify-center ring-offset-zinc-900 focus:outline-none focus:ring-2 focus:ring-fuchsia-600 focus:ring-offset-2 disabled:opacity-60',
    colorClass,
    sizeClass,
    className
  );
