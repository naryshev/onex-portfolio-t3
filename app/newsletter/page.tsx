            ...
            <form onSubmit={handleSubmit} >
              ...
              <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0 ">
                  <div className="relative w-full">
                      ...
                      <input className="animate-pulse block p-3 pl-10 w-full text-sm text-slate-950 bg-transparent border border-gray-300 sm:rounded-none sm:rounded-l-lg focus:ring-primary-500 focus:border-primary-900 dark:bg-transparent-700 dark:border-gray-300 dark:placeholder-gray-100 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter your email" type="email" id="email" onChange={(e) => setMail(e.target.value)} value={mail} />
                  </div>
                  <div>
                      ...
                      <button
                        type="submit"
                        className="hover:animate-pulse py-3 px-5 w-full text-sm font-medium text-center text-slate-50 border rounded-l-lg cursor-pointer bg-primary-700 border-primary-600 sm:rounded-none sm:rounded-r-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                    >
                        {loading ? (
                            <div
