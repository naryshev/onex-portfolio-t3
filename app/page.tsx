...
return (
    ...
    <div className="animate-fade-in flex items-center justify-center min-h-screen">
      <div className="text-center">
        {/* <Navigation /> */}
        <h1 id="ONEX RECORDS" className="animate-[bounce_ease-in-out_4s_infinite] h1word z-10 text-transparent duration-300 bg-white align-center bg-clip-text pt-50 mt-20">
          <motion.div
            drag
            whileHover={{ scale: 1.2 }}
            dragConstraints={{
