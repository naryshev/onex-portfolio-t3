      ...
      <WavyBackground  speed="slow" backgroundFill="#171719" blur={10} waveWidth={90}>
        <div className="h-[40rem] w-full rounded-md bg-transparent-950 relative flex flex-col items-center justify-center antialiased">
          <div className="max-w-2xl mx-auto p-4">
            <h1 className="relative z-10 text-3xl sm:text-7xl sm:text-  bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-400  text-center font-bold">
              Join our Newsletter
            </h1>
            <p></p>
            ...
            <form action="# ">
              <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                  <div className="relative w-full">
                      ...
                      <input className="block p-3 pl-10 w-full text-sm text-slate-950 bg-transparent rounded-lg border border-gray-300 sm:rounded-none sm:rounded-l-lg focus:ring-primary-500 focus:border-primary-900 dark:bg-transparent-700 dark:border-gray-300 dark:placeholder-gray-100 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter your email" type="email" id="email" />
                  </div>
                  <div>
                      <button type="submit" className="hover:animate-pulse py-3 px-5 w-full text-sm font-medium text-center text-slate-50 rounded-lg border cursor-pointer bg-primary-700 border-primary-600 sm:rounded-none sm:rounded-r-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Subscribe</button>
                  </div>
              </div>
